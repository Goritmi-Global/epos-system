...
const props = defineProps({
    title: { type: String, default: "Restore System" },
    message: { type: String, default: "Are you sure you want to restore the system? This will delete all orders, payments, purchases, and shifts data. This action cannot be undone!" },
