<template>
    <div>
        ...
        <Transition name="fade-slide">
            ...
            >
                <div
                    class="bg-white rounded-xl shadow-xl w-full max-w-md p-6 animate-drop-in relative"
                >
                    <!-- Close Button -->
                    ...
                    <!-- Text -->
                    <h3
                        class="text-center text-lg font-medium text-gray-800 mb-2"
                    >
                        {{ title }}
                    </h3>
                    ...
                    <div class="flex justify-center gap-3">
                        ...
                        <button
                            @click="handleCancel"
                            class="d-flex align-items-center gap-1 px-4 py-2 rounded-pill btn btn-secondary text-white"
                        >
                            No, cancel
                        </button>
                    </div>
