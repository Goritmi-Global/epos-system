...
const BRAND = "#1C0D82"; // your primary
...
function setLoaded() {
  try {
    ...
    console.error(e);
    toast.error("Stripe failed to initialize. Please reload and try again.");
  }
}
...
async function pay() {
  ...
  const params = new URLSearchParams({
    ...
    order_type:
      props.orderType === "dine_in" ? "Dine In" :
      props.orderType === "delivery" ? "Delivery" :
      props.orderType === "takeaway" ? "Takeaway" : "Collection",
