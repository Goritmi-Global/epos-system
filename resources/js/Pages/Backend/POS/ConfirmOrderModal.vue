    ...
    >
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content rounded-4 s border-0">
                <!-- Header -->
                <div
                    class="modal-header brand-gradient text-white py-3 position-sticky top-0 z-3"
                >
                    <h5
                        class="modal-title fw-bold d-flex align-items-center gap-2 m-0"
                    >
                                ...
                                <div class="card border-0 brand-card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            >
                                                <div
                                                    class="p-3 rounded-3 bg-light d-flex flex-column"
                                                >
                                                    <span
                                                        class="text-muted small"
                                                        >Table No</span
                                            ...
                                            <div
                                                class="table-responsive compact-table"
                                            >
                                                <table
...
.body-scroll {
    max-height: calc(90vh - 64px); /* header ~64px */
    overflow: auto;
}
</style>
