...
const sidebarMenus = ref([
  ...
  // Section: POS Management
  {
    ...
    children: [
      ...
      { label: "Analytics", icon: "bar-chart-2", route: "analytics.index" },
    ],
  },
  ...
  // Section: Other Menu
  {
    ...
    children: [
      ...
      { label: "Log Out", icon: "log-out", route: "logout", method: "post" },
    ],
  },
]);
    ...
    <div class="sidebar" id="sidebar">
      <div class="sidebar-inner slimscroll">
            ...
            <template v-for="block in sidebarMenus" :key="block.label || block.section">
              ...
              <li v-if="!block.section" :class="{ active: isActive(block.route) }">
                <Link :href="route(block.route)" class="d-flex align-items-center side-link px-3 py-2">
                  <i :data-feather="block.icon" class="me-2"></i>
              ...
              <!-- Section -->
              <template v-else>
                <li class="mt-3 mb-1 px-3 text-muted text-uppercase small">
                  {{ block.section }}
                </li>
                <li
        ...
        <div class="p-3 border-top small">
          ...
          <button class="btn btn-danger w-100 mb-2 rounded-pill">System Restore</button>
          <button class="btn btn-primary w-100 rounded-pill">Upgrade to Premium</button>
        </div>
      </div>
    </div>
    <!-- =================== /SIDEBAR =================== -->
