...
class ProfileStep6 extends Model
{
    ...
    protected $fillable = ['user_id','receipt_header','receipt_footer','receipt_logo_path','show_qr_on_receipt','tax_breakdown_on_receipt','kitchen_printer_enabled','printers'];
    protected $casts = [
        'printers' => 'array',
