import{_ as f,y as x,f as r,b as n,e as t,F as y,g as _,m as w,t as d,i as k,d as C,u as $}from"./app-DOXFdmcK.js";import{P as O}from"./printer-4Lq5MhCt.js";import"./createLucideIcon-D49DPPOu.js";const P={class:"modal fade",id:"posOrdersModal",tabindex:"-1","aria-hidden":"true"},T={class:"modal-dialog modal-xl modal-dialog-scrollable"},N={class:"modal-content"},L={class:"modal-header"},j={class:"modal-body"},F={key:0,class:"d-flex flex-column justify-content-center align-items-center",style:{height:"200px"}},I={key:1,class:"d-flex flex-column justify-content-center align-items-center",style:{height:"200px"}},B={key:2,class:"row g-3"},M={class:"card shadow-sm h-100 border rounded-3",style:{"border-color":"#e5e7eb"}},E={class:"card-body"},z={class:"d-flex justify-content-between align-items-start mb-3 border-bottom pb-2"},R={class:"mb-0 fw-bold"},S={class:"text-muted"},q={class:"text-end"},D={class:"badge bg-secondary rounded-pill d-block mb-1"},U={key:0,class:"mb-3"},V={class:"table table-sm align-middle mb-0"},A={class:"text-center"},J={class:"text-end"},Q={class:"bg-light rounded p-2 mb-3"},W={class:"d-flex justify-content-between"},G={class:"d-flex justify-content-between"},H={class:"text-end text-muted small"},K={class:"d-flex justify-content-center"},X=["onClick"],Y={__name:"PosOrdersModal",props:{show:Boolean,orders:Array,loading:Boolean},emits:["close","view-details"],setup(l,{emit:Z}){const h=l,c=a=>parseFloat(a).toFixed(2);function u(a){const e=JSON.parse(JSON.stringify(a)),s=(e.pos_order_type?.order?.payment?.payment_type||"").toLowerCase();let o="";s==="split"?o=`Payment Type: Split 
